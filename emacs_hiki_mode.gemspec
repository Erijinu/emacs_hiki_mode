...
#require 'emacs_hiki_mode/version'

Gem::Specification.new do |spec|
  spec.name          = "emacs_hiki_mode"
#  spec.version       = Emacs_Hiki_Mode::VERSION
  spec.authors       = ["Shigeto R. Nishitani"]
  spec.email         = ["shigeto_nishitani@me.com"]

  spec.summary       = %q{emacs els for hiki editing.}
  spec.description   = %q{.}
  spec.homepage      = "http://github.org/daddygongon/emacs_hiki_mode"
  spec.license       = "MIT"
